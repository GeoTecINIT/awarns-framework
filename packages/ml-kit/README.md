...
| `type`                 | `string`                                        | Always `classification-prediction`.                        |
| `change`               | `Change`                                        | Always `NONE`.                                             |
| `timestamp`            | `Date`                                          | The local time when the classification record was created. |
...
| Property     | Type                         | Description                                                                                                                |
|--------------|------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| `prediction` | `ClassificationPrediction[]` | Array of the classification predictions generated by the model, containing a `label` and classification `score` per class. |
| `timestamp`  | `Date`                       | The local time when the classification result was computed.                                                                |
...
|--------------------|-----------------------------------------|--------------------------------------------------------|
| `id`               | `string`                                | Record's unique id.                                    |
| `type`             | `string`                                | Always `regression-prediction`.                        |
| `change`           | `Change`                                | Always `NONE`.                                         |
| `timestamp`        | `Date`                                  | The local time when the regression record was created. |
...
| `timestamp`  | `Date`     | The local time when the regression result was computed.   |
